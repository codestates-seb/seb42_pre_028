...
=== 내가쓴 질문글 조회 (MyPage)
.curl-request
include::{snippets}/get-question-my-questions/curl-request.adoc[]
.path-parameters
include::{snippets}/get-question-my-questions/path-parameters.adoc[]
.request-parameters
include::{snippets}/get-question-my-questions/request-parameters.adoc[]
.http-request
include::{snippets}/get-question-my-questions/http-request.adoc[]
.request-body
include::{snippets}/get-question-my-questions/request-body.adoc[]
.http-response
include::{snippets}/get-question-my-questions/http-response.adoc[]
.response-fields
include::{snippets}/get-question-my-questions/response-fields.adoc[]
.response-body
include::{snippets}/get-question-my-questions/response-body.adoc[]

=== 내가쓴 답변글 조회 (MyPage)
.curl-request
include::{snippets}/get-answer-my-answers/curl-request.adoc[]
.path-parameters
include::{snippets}/get-answer-my-answers/path-parameters.adoc[]
.request-parameters
include::{snippets}/get-answer-my-answers/request-parameters.adoc[]
.http-request
include::{snippets}/get-answer-my-answers/http-request.adoc[]
.request-body
include::{snippets}/get-answer-my-answers/request-body.adoc[]
.http-response
include::{snippets}/get-answer-my-answers/http-response.adoc[]
.response-fields
include::{snippets}/get-answer-my-answers/response-fields.adoc[]
.response-body
include::{snippets}/get-answer-my-answers/response-body.adoc[]
=== 회원 탈퇴
.curl-request
